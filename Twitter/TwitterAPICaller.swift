...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "KHjQGBEclRmVw0fIEYtwtoGPs", consumerSecret: "UFHytWf7g6ECfd8iofQfNB60jea595Win6rYJDguzdrUMo37fE")
    var loginSuccess: (() -> ())?
